var bigInt = function (e) {
    ...
    function x(e, t) {
        ...
        n = Math.ceil(n / 2);
        var r = e.slice(n), i = e.slice(0, n), s = t.slice(n), o = t.slice(0, n), u = x(i, o), a = x(r, s), f = x(v(i, r), v(o, s));
    ...
    function L(e, n) {
        var r, i = z(n), s = e.value, a = i.value, c;
    ...
    function P(e, t, n) {
        t = z(t);
        var r = e.isNegative(), i = t.isNegative(), s = r ? e.not() : e, o = i ? t.not() : t, u = [], a = [], f = !1, l = !1;
    ...
    function I(e, n) {
        e = z(e), n = z(n);
        var r = B(e, n), i = H(e, n), s = i.subtract(r);
    ...
    o.prototype.add = function (e) {
        ...
        var n, r = z(e), i = this.value, s = r.value, u = this.sign !== r.sign, a;
        if (r.isSmall) {
            if (s === 0)return W[0];
            if (s === 1)return this;
        ...
        var n = z(e), r = this.value, i = n.value;
        if (r === 0)return W[0];
        if (r === 1)return n;
        ...
        var t = z(e), n = this.value, r = t.value, i, s, o;
        if (r === 0)return W[1];
        if (n === 0)return W[0];
        if (n === 1)return W[1];
        ...
        var t = z(e), n = this.value, r = t.value;
        return t.isSmall ? 1 : A(n, r);
    }, u.prototype.compareAbs = function (e) {
        var t = z(e), n = Math.abs(this.value), r = t.value;
        ...
        var n = [2, 3, 5, 7, 11, 13, 17, 19], r = t, i, s, o, u;
