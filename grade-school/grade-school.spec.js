...
describe('School', function() {
  ...
  it('adding more kids to the same grade adds them to the roster', function() {
    school.add('Blair',2);
    school.add('James',2);
    school.add('Paul',2);
  ...
  it('adding kids to different grades adds them to the roster', function() {
  ...
  it('grade returns the kids in that grade in alphabetical order', function() {
  ...
  it('grade returns an empty array if there are no kids in that grade', function() {
    expect(school.grade(1)).toEqual([]);
  });

  it('the kids names in each grade in the roster are sorted', function() {
